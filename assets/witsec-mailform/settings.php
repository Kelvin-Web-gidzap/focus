...
$_SETTINGS = [
	"to"						=> "zakaz@my-car-parts.ru",							// To Address
	"toAlt"						=> "",						// Additional Recipients
	"from"						=> "zakaz@my-car-parts.ru",						// From Address
	"fromName"					=> "my-car-parts.ru",					// From Name
	...
	"autorespondSubject"		=> "my-car-parts.ru",			// Autorespond Custom Subject
